...
def build_collate(
    ...
    def _collate(batch: List[Dict]) -> Dict:
        ...
        if backend == "hf":
            ...
            text_inputs = {"input_ids": oc_tokenizer(captions)}
...
def main() -> None:
    ...
    ap.add_argument("--train_jsonl", type=str, default="outputs/initial_caption.jsonl")
    ...
    ap.add_argument("--save_dir", type=str, default="outputs/initial_itc")
    ...
    ap.add_argument("--train_image_root", type=str, default="/home/u2024218474/jupyterlab/PSPD/dataset/CUHK-PEDES")
    ap.add_argument("--eval_image_root", type=str, default="/home/u2024218474/jupyterlab/PSPD/dataset/CUHK-PEDES")
